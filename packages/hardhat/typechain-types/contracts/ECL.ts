...
export interface ECLInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "FEE_PERCENTAGE"
      | "MAX_WINNERS"
...
export interface ECL extends BaseContract {
  connect(runner?: ContractRunner | null): ECL;
  ...
  getCreators: TypedContractMethod<[], [IECL.CreatorStructOutput[]], "view">;
