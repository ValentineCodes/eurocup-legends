...
export interface UPMockInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "fund"
      | "getBalance"
...
export interface UPMock extends BaseContract {
  connect(runner?: ContractRunner | null): UPMock;
  waitForDeployment(): Promise<this>;

  interface: UPMockInterface;
