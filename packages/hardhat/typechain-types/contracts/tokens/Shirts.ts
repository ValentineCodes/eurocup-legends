...
export interface ShirtsInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "MAX_MINT"
      | "MAX_SUPPLY"
...
export namespace ShirtsMintedEvent {
...
export interface Shirts extends BaseContract {
  connect(runner?: ContractRunner | null): Shirts;
  waitForDeployment(): Promise<this>;

  interface: ShirtsInterface;
  ...
  MAX_MINT: TypedContractMethod<[], [bigint], "view">;
  ...
  getPrizePool: TypedContractMethod<[], [string], "view">;
  ...
  getEvent(
    ...
    ShirtsMintedEvent.InputTuple,
    ShirtsMintedEvent.OutputTuple,
    ShirtsMintedEvent.OutputObject
  >;
  getEvent(
  ...
  filters: {
    ...
    "ShirtsMinted(address,uint256)": TypedContractEvent<
      ShirtsMintedEvent.InputTuple,
      ShirtsMintedEvent.OutputTuple,
      ShirtsMintedEvent.OutputObject
    >;
    ShirtsMinted: TypedContractEvent<
      ShirtsMintedEvent.InputTuple,
      ShirtsMintedEvent.OutputTuple,
      ShirtsMintedEvent.OutputObject
    >;
