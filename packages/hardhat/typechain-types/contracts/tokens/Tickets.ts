...
export namespace TicketsMintedEvent {
...
export interface Tickets extends BaseContract {
  ...
  getEvent(
    ...
    TicketsMintedEvent.InputTuple,
    TicketsMintedEvent.OutputTuple,
    TicketsMintedEvent.OutputObject
  >;
  getEvent(
    key: "Transfer"
  ): TypedContractEvent<
  ...
  filters: {
    ...
    "TicketsMinted(address,uint256)": TypedContractEvent<
      TicketsMintedEvent.InputTuple,
      TicketsMintedEvent.OutputTuple,
      TicketsMintedEvent.OutputObject
    >;
    TicketsMinted: TypedContractEvent<
      TicketsMintedEvent.InputTuple,
      TicketsMintedEvent.OutputTuple,
      TicketsMintedEvent.OutputObject
    >;
