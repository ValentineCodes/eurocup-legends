...
export interface IShirtsInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeOperator"
      | "balanceOf"
...
export interface IShirts extends BaseContract {
  connect(runner?: ContractRunner | null): IShirts;
  waitForDeployment(): Promise<this>;

  interface: IShirtsInterface;
