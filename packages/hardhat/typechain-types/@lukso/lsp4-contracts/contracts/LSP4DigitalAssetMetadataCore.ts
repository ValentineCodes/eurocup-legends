...
export interface LSP4DigitalAssetMetadataCoreInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "getData"
      | "getDataBatch"
...
export interface LSP4DigitalAssetMetadataCore extends BaseContract {
  connect(runner?: ContractRunner | null): LSP4DigitalAssetMetadataCore;
  waitForDeployment(): Promise<this>;

  interface: LSP4DigitalAssetMetadataCoreInterface;
