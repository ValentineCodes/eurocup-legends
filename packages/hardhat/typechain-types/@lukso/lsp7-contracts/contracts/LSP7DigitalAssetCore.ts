...
export interface LSP7DigitalAssetCoreInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeOperator"
      | "authorizedAmountFor"
...
export interface LSP7DigitalAssetCore extends BaseContract {
  connect(runner?: ContractRunner | null): LSP7DigitalAssetCore;
  waitForDeployment(): Promise<this>;

  interface: LSP7DigitalAssetCoreInterface;
