...
export interface LSP8IdentifiableDigitalAssetCoreInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeOperator"
      | "balanceOf"
...
export interface LSP8IdentifiableDigitalAssetCore extends BaseContract {
  connect(runner?: ContractRunner | null): LSP8IdentifiableDigitalAssetCore;
  waitForDeployment(): Promise<this>;

  interface: LSP8IdentifiableDigitalAssetCoreInterface;
