...
import type {
  ...
  LSP8IdentifiableDigitalAssetCoreInterface,
} from "../../../../@lukso/lsp8-contracts/contracts/LSP8IdentifiableDigitalAssetCore";
...
export class LSP8IdentifiableDigitalAssetCore__factory {
  static readonly abi = _abi;
  static createInterface(): LSP8IdentifiableDigitalAssetCoreInterface {
    return new Interface(_abi) as LSP8IdentifiableDigitalAssetCoreInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as LSP8IdentifiableDigitalAssetCore;
  }
}
