...
import type {
  ...
  LSP8IdentifiableDigitalAssetInterface,
} from "../../../../@lukso/lsp8-contracts/contracts/LSP8IdentifiableDigitalAsset";
...
export class LSP8IdentifiableDigitalAsset__factory {
  static readonly abi = _abi;
  static createInterface(): LSP8IdentifiableDigitalAssetInterface {
    return new Interface(_abi) as LSP8IdentifiableDigitalAssetInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as LSP8IdentifiableDigitalAsset;
  }
}
