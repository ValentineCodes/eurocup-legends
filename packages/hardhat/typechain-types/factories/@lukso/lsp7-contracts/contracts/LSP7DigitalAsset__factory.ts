...
import type {
  LSP7DigitalAsset,
  LSP7DigitalAssetInterface,
} from "../../../../@lukso/lsp7-contracts/contracts/LSP7DigitalAsset";
...
export class LSP7DigitalAsset__factory {
  static readonly abi = _abi;
  static createInterface(): LSP7DigitalAssetInterface {
    return new Interface(_abi) as LSP7DigitalAssetInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): LSP7DigitalAsset {
    return new Contract(address, _abi, runner) as unknown as LSP7DigitalAsset;
  }
}
